        ...
        <section>
            <div class="container animated fadeIn">
                <div class="register-form">
                    ...
                    <form:form id="paymentForm" class="form-horizontal white-font" modelAttribute="playerObject"
                               method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <form:input path="alias" type="text" class="form-control" id="alias"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="checkbox-inline"><input type="checkbox" class="require-one"
                                                                      name="social_acc" value="Instagram"
                                                                      id="instagram">Instagram</label>
                                <label class="checkbox-inline"><input type="checkbox" class="require-one"
                                                                      name="social_acc" value="Twitter" id=twitter>Twitter</label>
                        ...
                        <fieldset id="tweet">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <form:input path="twitterHandle" type="text" class="form-control" id="twitterHandle"
                                                placeholder="Twitter"/>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset id="gram">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <form:input path="instagramHandle" type="text" class="form-control"
                                                id="instagramHandle" placeholder="Instagram"/>
                                </div>
                            </div>
                        </fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 teamSel">
                                <select name="teamSelected" class="form-control select-drop" id="team"
                                        style="color: limegreen;"></select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="selectedTeam">Selected Team:</label>
                            <div class="col-sm-10">
                                <p id="selectedTeam" class="form-control-static"
                                   style="font-size: 20px; color: springgreen"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="location">Location:</label>
                            <div class="col-sm-10">
                                <label class="radioBtn"><form:radiobuttons path="location"
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 text-center">
                                ...
                                <p class="gold" style="padding-top: 10px;">Want to pay cash? click <a
                                        style="text-decoration: none; font-size: inherit; color: springgreen"
                                        href="<spr:url value="/enter/registrationCenters"/> ">here</a></p>
                            </div>
                        </div>
                    </form:form>
                </div>
