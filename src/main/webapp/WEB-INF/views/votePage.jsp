    ...
    <section>
        <div class="no-pad about-content animated fadeInDownBig">
            <div class="about-details text-center mont-Font">
                ...
                <br/>
                <form:form id="paymentForm" class="form-horizontal white-font" modelAttribute="voteObject"
                           method="post">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="Alias">PLAYER ALIAS:</label>
                        <div class="col-sm-10">
                            <form:select id="Alias" path="playerAlias" cssClass="form-control"
                                         items="${votes}"></form:select>
                        </div>
                    </div>
                    <div class="form-group">
