    ...
    <section class="container">
        <div class="no-pad about-content animated fadeInDownBig">
            <div class="faq-details text-left mont-Font">
                ...
                <p class="gold" style="margin-bottom: 2px;">&#8595; Send evidence of payment (your teller) and  your registration data to <a href="mailto:info@thelxg.com.ng" style="text-decoration: none; color:rgb(32, 28, 85);; font-size: inherit">info@thelxg.com.ng </a></p>
