...
<footer id="footer" class="bg-footer">
    <div class="container-fluid text-center">
        <div class="col-sm-3 white-font">
            <H4><img src="<spr:url value="/resources/images/theLXGlogo-small.png"/>" class="img-responsive footer-img"
        ...
        <div class="col-sm-3 white-font">
            <ul class="footer-li">
                ...
                <li><a href="<spr:url value="/fiesta/home"/> ">LXG'17 FIESTA <span class="sr-only">(current)</span></a>
                </li>
        ...
        <div class="row">
            <div class="col-xs-offset-2 col-xs-8 text-center white-font no-bottom-margin bottom-foot">
                ...
                <p class="no-bottom-margin">
                    <small>Website made By <a onclick="openInNewTab('https://twitter.com/recks11')" href="#footer">Ijiekhuamen
                        Rex</a></small>
                </p>
                <p>
