            ...
            <div class="container animated fadeIn">
                <div class="register-form">
                    ...
                    <form:form id="paymentForm" class="form-horizontal white-font" modelAttribute="playerObject"
                               method="post" action="change.team">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <p class="form-control-static" id="firstname"
                                   style="font-size: 20px;"> ${playerObject.firstName}</p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <p id="lastname" class="form-control-static"
                                   style="font-size: 20px;"> ${playerObject.lastName}</p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <p class="form-control-static" id="plalyerAlias"
                                   style="font-size: 20px;"> ${playerObject.alias}</p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <p id="lxgId" class="form-control-static"
                                   style="font-size: 20px; color: springgreen"> ${playerObject.playerId} </p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <p id="selectedTeam" class="form-control-static"
                                   style="font-size: 20px; color: springgreen"> ${playerObject.teamSelected}</p>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 text-center">
                                ...
                                <button id="registerBtn" type="submit" class="submitBtn btn-default">Change Team
                                </button>
                            </div>
                        </div>
                    </form:form>
