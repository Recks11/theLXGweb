                ...
                <div class="register-form">
                    ...
                    <form:form class="form-horizontal white-font" modelAttribute="vendorObject" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <form:input type="text" class="form-control" path="businessName" id="fname" placeholder="Business Name"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <form:textarea path="description" type="text" class="form-control description" id="description" placeholder="Description" rows="5" cssStyle="
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radioBtn"><form:radiobuttons path="standLocation" items="${locationList}"></form:radiobuttons></label>
